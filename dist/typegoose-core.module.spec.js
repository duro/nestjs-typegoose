...
describe('TypegooseCoreModule', () => {
    ...
    describe('Disconnect in onModuleDestroy', () => {
        it('should close connection while destroying module', async () => {
            ...
            const coreModule = new typegoose_core_module_1.TypegooseCoreModule(typegoose_constants_1.DEFAULT_DB_CONNECTION_NAME, {
                get: moduleRefGet
            });
            await coreModule.onModuleDestroy();
            expect(moduleRefGet).toHaveBeenCalledWith(typegoose_constants_1.DEFAULT_DB_CONNECTION_NAME);
